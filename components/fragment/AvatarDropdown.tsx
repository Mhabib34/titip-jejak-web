...
export function AvatarDropdown() {
  ...
  return (
    <div ref={ref} className="relative ">
      <button
        onClick={() => setOpen((o) => !o)}
        className="w-8 h-8 rounded-full bg-orange-100 flex items-center justify-center text-sm font-bold text-orange-600 hover:bg-orange-200 transition-colors cursor-pointer"
      >
        {initial}
      </button>
        ...
        <div className="absolute right-0 top-full mt-2 w-52 rounded-2xl border border-stone-200 bg-white shadow-xl shadow-stone-100 overflow-hidden z-50">
          ...
          <div className="border-t border-stone-100 p-1.5">
            <button
              onClick={() => {
                setOpen(false);
                showConfirm("Anda yakin ingin keluar?", "", logout, "Keluar");
              }}
              disabled={isPending}
