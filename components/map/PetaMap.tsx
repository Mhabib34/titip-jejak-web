...
// ── Pin popup ─────────────────────────────────────────────────────────────────
function PinPopup({ pin, onNavigate }: { pin: MapPin; onNavigate: (id: string) => void }) {
    const isMissing = pin.type === "missing";
    const badgeClass = isMissing ? "bg-red-500 text-white" : "bg-green-500 text-white";
    const badgeLabel = isMissing ? "Hilang" : "Ditemukan";
    const genderLabel =
        pin.gender === "male" ? "Laki-laki" : pin.gender === "female" ? "Perempuan" : "?";
